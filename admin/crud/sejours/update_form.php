...
<form action="update_query.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Difficulte</label>
        <div class="col-sm-10">
            <input type="number" name="difficulte" value="<?php echo $sejour["difficulte"]; ?>" class="form-control" placeholder="Difficulte">
        </div>
    </div>
    <div class="form-group row">
